...
public class Entity {
    ...
    public Projectile shootAtXY(float x, float y){ // shoot at XY coordinates on map not camera
        if(cooldown-- < 1) {
            ...
            return new Projectile(this, "bullet.png", x - this.centerX, y - this.centerY, this.projectileType.height, this.projectileType.width, this.projectileType.speed, this.attackrange);
        }else{
            cooldown--;
            return null;
        }
