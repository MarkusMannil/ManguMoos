...
public enum TileType {
    ...
    BEACHSIDE1(9, TextureRegion.split(new Texture("assets/sprites/beach.png"),64,64),0,7,true,false),
    BEACHSIDE2(10, TextureRegion.split(new Texture("assets/sprites/beach.png"),64,64),2,7,true,false),
    BEACHSIDE3(11, TextureRegion.split(new Texture("assets/sprites/beach.png"),64,64),4,7,true,false),
